...
// current implementation: M35,0.75 L34.09375,2.5625
// future implementation: M 382.49999 494.99999 L 384.55374 496.87223

// HOWTO: split string on every character regex
      ...
      switch (`${command}`) {
        ...
        case "Z": // close path command
          ...
          if (
            ...
            result = [...previouseLines, [...currentLine, fistPoint]];
          } else {
            console.warn(
        ...
        case "L": // L (line) command draws to a new coordinate
          result = [...previouseLines, [...currentLine, args]];
          break;
        default:
          console.error(
